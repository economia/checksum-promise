(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["checksum-promise"] = factory();
	else
		root["checksum-promise"] = factory();
...
var _sparkMd = __webpack_require__(1);

var _sparkMd2 = _interopRequireDefault(_sparkMd);

var _promiseFileReader = __webpack_require__(2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var DEFAULT_CHUNK_SIZE = 10485760;
...
var Checksum = function () {
  ...
  _createClass(Checksum, [{
    key: 'calculateMd5',
    value: function calculateMd5(file) {
      var _this = this;
      ...
      return new Promise(function (resolve, reject) {
        ...
        return _this.readSlice().then(function () {
    ...
    key: 'readSlice',
    value: function readSlice() {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        var blobSlice = _this2.blobSlice,
            chunks = _this2.chunks,
            currentChunk = _this2.currentChunk,
            file = _this2.file,
        ...
        return (0, _promiseFileReader.readAsArrayBuffer)(blobSlice.call(file, start, end)).then(function (loadedArrayBuffer) {
          spark.append(loadedArrayBuffer);
          currentChunk++;
          if (currentChunk < chunks) {
            return _this2.readSlice().then(function () {
              return resolve();
            });
          } else {
            return resolve();
